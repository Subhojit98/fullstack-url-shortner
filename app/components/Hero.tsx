        ...
        <div className="w-full h-screen relative">
            ...
            <nav className="flex items-center justify-between w-full px-6 md:px-20 mt-5">
                ...
                <div className="flex items-center sm:gap-5">
                    <Button className="px-4 py-4 sm:px-6 sm:py-6 text-xs sm:text-sm border border-gray-600 text-white gradient-1 rounded-lg cursor-pointer hover:opacity-90 hover:border-white duration-200 ease-in-out" onClick={handleLogin}>Login</Button>
                    <Button className="hidden sm:inline-flex px-4 py-4 sm:px-6 sm:py-6 text-xs sm:text-sm  text-white gradient-2 rounded-lg items-center gap-2 cursor-pointer hover:opacity-90 group" onClick={handleGetStarted}>
            ...
            <div className="flex flex-col items-center mt-20 mx-auto">
                ...
                <button className="relative cursor-pointer mt-10 inline-flex bg-background items-center px-12 py-3 overflow-hidden text-sm sm:text-lg font-medium border-2 border-indigo-600 rounded-lg text-white group" onClick={handleShorten}>
                    ...
                    {
                        isLoading ? <Spinner /> : <>  <span className="absolute right-0 flex items-center justify-start w-10 h-10 duration-300 transform translate-x-full group-hover:translate-x-0 ease">
