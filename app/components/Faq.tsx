        ...
        <div className="w-full h-full mb-40 flex flex-col items-center gap-10 justify-center mt-20 text-white">
            ...
            >
                <AccordionItem value="item-1">
                    <AccordionTrigger className="py-10">Product Information</AccordionTrigger>
                ...
                <AccordionItem value="item-2">
                    <AccordionTrigger className="py-8">Shipping Details</AccordionTrigger>
                    <AccordionContent className="flex flex-col gap-4 text-balance">
                        <p>
                ...
                <AccordionItem value="item-3">
                    <AccordionTrigger className="py-8">Return Policy</AccordionTrigger>
                    <AccordionContent className="flex flex-col gap-4 text-balance">
                        <p>
